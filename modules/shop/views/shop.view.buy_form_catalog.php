...
<div class="catalogitems__buttons">
...
echo '		<div class="catalogitems__prices">';
if ($result["row"]["price_arr"])
{
	foreach ($result["row"]["price_arr"] as $price)
	{
		...
		echo '<div class="js_shop_param_price shop_param_price shop-item-price"'.$param_code.'>';
			...
			{
				echo '<span class="shop_old_price price-old catalogitems__oldprice"><span class="shop_price_value strike">'.number_format($price["old_price"], 0, '', ' ').' '.$result["result"]["currency"].'</span></span>';
			}
			...
			echo '<span class="price"><span class="js_shop_price catalogitems__price" summ="'.$price["price_no_format"].'" format_price_1="'.$this->diafan->configmodules("format_price_1", "shop").'" format_price_2="'.$this->diafan->configmodules("format_price_2", "shop").'" format_price_3="'.$this->diafan->configmodules("format_price_3", "shop").'">'.number_format($price["price"], 0, '', ' ').'</span> '.$result["result"]["currency"];
